...
class allProducts extends StatefulWidget {
  ...
  String dbname1;
  String dbname2;
  allProducts({required this.myList,this.mail,required this.dbname1,required this.dbname2});
  @override
  allProductsPage createState() => allProductsPage(myList: myList,mail: mail,dbname1: dbname1,dbname2: dbname2);
}
class allProductsPage extends State<allProducts>{
  List<Product> myList;
  String? mail;
  String dbname1;
  String dbname2;
  allProductsPage({required this.myList,this.mail,required this.dbname1,required this.dbname2});
